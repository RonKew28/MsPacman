...
document.addEventListener("DOMContentLoaded", function(){
  ...
  ctx.beginPath();
  ctx.moveTo(110, 60);
  ctx.arc(120, 60, 10, 1*Math.PI, 1.5*Math.PI, false);
  ctx.stroke();

  ctx.beginPath();
  ctx.moveTo(120, 50);
  ctx.arc(120, 60, 10, 1.5*Math.PI, 0, false);
  ctx.stroke();

ctx.beginPath();
ctx.moveTo(120, 70);
ctx.arc(120, 60, 10, 0.5*Math.PI, 1*Math.PI, false);
ctx.stroke();

ctx.beginPath();
ctx.moveTo(130, 60);
ctx.arc(120, 60, 10, 0, 0.5*Math.PI, false);
ctx.stroke();
...
throw new Error("Module parse failed: /Users/ronnie/Desktop/MsPacman/lib/board.js Unexpected token (2:13)\nYou may need an appropriate loader to handle this file type.\n| (function() {\n|   if (typeOf App === \"undefined\") {\n|     window.App = {};\n|   }");
